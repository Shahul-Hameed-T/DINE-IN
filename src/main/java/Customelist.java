...
public class Customelist extends BaseAdapter {
    ...
    public Customelist(Context c, ArrayList<String> nam, ArrayList<String> cmd, ArrayList<String> cunt, ArrayList<byte[]> img)
    {
        this.con=c;
        this.nmlis=nam;
        this.cmdlis=cmd;
    ...
    public View getView(int i, View v, ViewGroup parent) {
        ...
        cmmd.setText("Food Name: "  + cmdlis.get(i));
        counnt.setText("Food Cost: "  + countlis.get(i));
